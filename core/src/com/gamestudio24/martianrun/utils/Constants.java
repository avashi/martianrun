...
public class Constants {
    ...
    //change up these to adjust jumping of runner
    ...
    //try to make enemies extra long
    //not this line.. determines how far away newly spawned enemies start from
    public static final float ENEMY_X = 25f;
    //how many enemies?
    public static final float ENEMY_DENSITY = RUNNER_DENSITY;
    //length again?
    //nah these 3 adjust the y axis location of the enemy types.... original: 1.5,2,3
